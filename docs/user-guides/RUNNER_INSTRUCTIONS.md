...
The signup process takes just a few minutes and ensures you're registered and have accepted the necessary safety waivers.
...
The registration form has several fields. Here's what you need to know:

#### Name *
- Enter your full name as you'd like it to appear on the signup list
- This field is required
- Example: "Michael Johnson" or "Sarah Chen"

[SCREENSHOT: Name field in the registration form]
...
### Step 4: Read and Accept the Waiver

Before you can complete your registration, you must read and accept the Electronic Waiver of Liability, Media Release, Code of Conduct, and Communication Consent.

1. **Read the waiver**: Scroll through the waiver text in the box provided
   - The waiver covers important safety information, liability, media consent, and code of conduct
   - Take your time to read through it carefully

[SCREENSHOT: Waiver text displayed in scrollable box]

2. **Accept the waiver**: 
   - Check the box that says: "I accept the Electronic Waiver of Liability, Media Release, Code of Conduct, and Communication Consent. (Required to complete registration)"
   - This checkbox is required - you cannot submit the form without accepting

[SCREENSHOT: Checkbox for accepting the waiver]

**Note**: The Sign Up button will remain disabled until you fill in your name, phone number, and accept the waiver.

### Step 5: Submit Your Registration

1. Once you've filled in your name and phone number, and accepted the waiver, the **"Sign Up"** button will become active

2. Click the **"Sign Up"** button to submit your registration

3. The form will process your submission (this may take a few seconds)
...
The signup page includes an inline quick guide:
- Look for the **"User Guides"** collapsible section at the top of the page
- Click it to expand and see a condensed version of the signup instructions
- Perfect for quick reference while filling out the form
...
- The map may take a moment to load
...
4️⃣ Read & accept the waiver (required)
