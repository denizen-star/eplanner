...
<body>
  ...
  <div class="email-content">
    ...
    <div class="glass-box qr-code-box">
      ...
      <p class="link-description" style="font-size: 15px; color: #333; margin-top: 12px;">No gatekeeping allowed—send the QR/ Link to your friends! It's just gonna be a chill time. Lets catch the vibe togeher.</p>
    </div>
  </div>
