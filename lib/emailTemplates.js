...
function generateEmailFooter(imagePath, imageAlt, genZText, baseUrl = 'https://eplanner.kervinapps.com', warmBeige = '#F7F3ED', darkBorder = '#34495E') {
  ...
  return `
    <div style="background-color: ${warmBeige}; padding: 0; margin-top: 40px; position: relative;">
      <!-- Decorative Arch -->
      <div style="width: 100%; height: 30px; background: ${warmBeige}; position: relative; overflow: hidden;">
        <div style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 200px; height: 60px; background: ${warmBeige}; border-radius: 100px 100px 0 0; border-top: 2px solid ${darkBorder};"></div>
      </div>
