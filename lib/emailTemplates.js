...
<body>
  ...
  <div class="email-content">
    ...
    ` : eventDescription ? `
    <div class="glass-box">
      <div class="link-label" style="font-size: 16px;">Event Description:</div>
      <div style="margin-top: 8px; color: #333; line-height: 1.6; white-space: pre-wrap; font-size: 16px;">${eventDescription.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/\n/g, '<br>')}</div>
    </div>
