...
function generateStaticMapUrl(coordinates) {
  ...
  return `https://staticmap.openstreetmap.de/staticmap.php?center=${lat},${lon}&zoom=15&size=140x140&markers=${lat},${lon},red`;
}
  ...
  <div class="email-content">
    ...
    <div class="event-details-glass">
      ...
      <div class="static-map-container">
        <img src="${staticMapUrl}" alt="Event Location Map" class="static-map" />
