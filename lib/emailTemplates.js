 ...
 */
function eventCancelledEmail(run, signup) {
  const eventTitle = run.title || 'Event';
  const participantName = signup.name || 'Participant';
  const location = run.location || 'Location TBD';
  const dateTime = formatDate(run.dateTime, run.timezone);
...
We apologize for any inconvenience this may cause. If you have any questions, please contact the event coordinator.
...
<body>
  ...
  <div class="email-content">
    <div class="content-section">
      ...
      <p style="padding: 0 20px 20px 20px; font-size: 16px;">We apologize for any inconvenience this may cause. If you have any questions, please contact the event coordinator.</p>
