 ...
 * Re-exports signup/notification templates from backup and adds weekly digest template.
 */

const {
  signupConfirmationEmail,
  signupNotificationEmail,
} = require('./emailTemplates.js.backup');
...
<body style="font-family: sans-serif; line-height: 1.5; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="margin-top: 0;">Your weekly planned events</h2>
  <p>Here are the upcoming events for the next 7 days.</p>
  ${htmlCards || '<p>No events in the next 7 days.</p>'}
