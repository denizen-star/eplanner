...
const runs = {
  ...
  async update(runId, updates) {
    ...
    if (updates.house_number !== undefined) {
      ...
      values.push(updates.house_number ? updates.house_number.trim() : null);
    }
    if (updates.road !== undefined) {
      fields.push('road = ?');
      values.push(updates.road ? updates.road.trim() : null);
    }
    ...
    if (updates.city !== undefined) {
      fields.push('city = ?');
      values.push(updates.city ? updates.city.trim() : null);
    }
    ...
    if (updates.state !== undefined) {
      fields.push('state = ?');
      values.push(updates.state ? updates.state.trim() : null);
    }
    if (updates.postcode !== undefined) {
      fields.push('postcode = ?');
      values.push(updates.postcode ? updates.postcode.trim() : null);
    }
    if (updates.country !== undefined) {
      fields.push('country = ?');
      values.push(updates.country ? updates.country.trim() : null);
    }
