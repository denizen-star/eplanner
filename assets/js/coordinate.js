...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const collectionDateWrap = document.getElementById('collectionDateWrap');
  ...
  function updatePaymentDetailsVisibility() {
    ...
    if (!isPaid) {
      ...
      if (collectionDateWrap) collectionDateWrap.style.display = 'none';
    } else {
  ...
  if (paymentTypeToggle) {
    paymentTypeToggle.addEventListener('change', updatePaymentDetailsVisibility);
  }
...
document.getElementById('coordinateForm').addEventListener('submit', async (e) => {
  ...
  try {
    ...
    const paymentTypeToggleEl = document.getElementById('paymentTypeToggle');
    const isPaid = paymentTypeToggleEl && paymentTypeToggleEl.checked;
